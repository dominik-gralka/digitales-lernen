        ...
        <div className="px-7 lg:px-32 min-h-screen">
            ...
            <main className="">
                ...
                <div className={client ? '' : 'hidden'}>
                    ...
                    <a className={`${countdown > 0 ? 'hidden' : 'hover:bg-red-600'} lg:w-80 w-full mt-10 bg-red-500 transition-all p-3 px-5 flex justify-center text-white rounded-md font-lg text-md mb-5 cursor-pointer`}>Nutzerkonto unwiderruflich kündigen</a>
                </div>
