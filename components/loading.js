...
export const Loading = () => {
  return (
    <div className="px-7 lg:px-32 min-h-screen ">
      ...
      <Head>
        <title>Digitales Lernen: Laden...</title>
        <meta
          name="description"
      ...
      <main className="">
        ...
        <div className="text-4xl font-bold my-2 py-2 bg-gray-100 animate-pulse w-64 rounded">
          &nbsp;
        </div>

        <div className="bg-gray-100 animate-pulse w-64 rounded mt-10">
          &nbsp;
        </div>
